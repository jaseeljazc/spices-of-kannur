...
const timeline = [
  {
    year: "2001",
    event:
      "Began his journey studying Electronics and Communication, navigating entrance exams and building early resilience.",
  },
  {
    year: "2008",
    event:
      "Started a successful IT career in Dubai, where extensive travel sparked a deep passion for discovering global cuisines.",
  },
  {
    year: "2015",
    event:
      "Participated in 'Dhe Chef', a turning point that gave him the confidence to transition fully into the culinary world.",
  },
  {
    year: "2016",
    event:
      "Received the prestigious honour of setting up a restaurant for the Indian Navy, serving national Defence Ministers.",
  },
  {
    year: "2023",
    event:
      "Stepped forward independently to build his own culinary identity, rooting his craft in authentic Kannur traditions.",
  },
];

const brandValues = [
  {
    icon: <WheatSheafIcon className="w-12 h-12" />,
    title: "Heritage",
    desc: "Every blend traces back to a Malabar kitchen, a grandmother's hand, and a wedding feast that lingered for days.",
  },
  {
    icon: <LeafIcon className="w-12 h-12" />,
    title: "Purity",
    desc: "No artificial colours, no preservatives, no shortcuts. Just spice — the way it was always meant to be.",
  },
  {
    icon: <MortarPestleIcon className="w-12 h-12" />,
    title: "Craft",
    desc: "Stone-ground on traditional chakki, blended in small batches, packed within 48 hours of grinding.",
  },
];
    ...
    >
      ...
      >
        <Image
          ...
          style={{ objectFit: "contain", width: 'clamp(180px, 25vw, 350px)', height: 'auto' }}
        />
      </div>
      <ScrollReveal
        style={
          { textAlign: "center", marginBottom: "64px" } as React.CSSProperties
        }
      >
        <p
          style={{
...
export function StoryPage() {
  ...
  useGSAP(
    () => {
      gsap.fromTo(
        titleContainer.current!.children,
        { opacity: 0, y: 30 },
        {
          opacity: 1,
          y: 0,
...
export function HeritageSection() {
  return (
    <section
      style={{ background: "var(--color-charcoal)", padding: "96px 16px" }}
      id="heritage"
    >
      <div className="story-kannur-grid">
        <ScrollReveal>
          <KannurSkyline
            ...
            opacity={0.8}
            style={
              { filter: "sepia(0.4) brightness(0.8)" } as React.CSSProperties
            }
          />
        </ScrollReveal>
        <div
        ...
        >
          <ScrollReveal>
            ...
            >
              Thalassery biriyani is not just a dish — it is a ceremony. The
              short-grain Khyma rice, the fragrant Malabar spices, the slow dum
              — every element is deliberate, honed over generations by the
              coastal kitchens of Kannur. It is the centrepiece of every Malabar
              wedding feast, served to hundreds, cooked in iron vessels over
              wood fire.
            </p>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
            ...
            >
              Kannur's spice heritage stretches back to the Malabar trade routes
              — black pepper, cardamom, cloves shipped from its shores to the
              world. We grew up breathing this history, in kitchens that smelled
              of whole spices being dry-roasted on iron pans.
            </p>
          </ScrollReveal>
        </div>
      </div>
    ...
    >
      ...
      >
        <Image
          ...
          height={250}
          alt="Background Pattern"
          style={{ objectFit: "contain", width: 'clamp(120px, 15vw, 250px)', height: 'auto' }}
        />
      </div>
      <div className="chef-grid">
        <div
          style={{ position: "relative", maxWidth: "320px", margin: "0 auto" }}
        >
          <ScrollReveal>
            <Image
              src="/images/chef2-image.jpeg"
              alt="Spices of Kannur"
              width={320}
              height={380}
...
export function ValuesSection() {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/images/pattern/Picsart_26-05-05_22-11-23-452.png"
          width={400}
          height={400}
          alt="Background Pattern"
      ...
      <div ref={gridRef} className="values-grid">
        {brandValues.map((v) => (
          <div key={v.title} style={{ opacity: 0 }}>
            <div
              style={{
